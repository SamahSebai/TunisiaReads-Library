...
//Importation de l'entité UserBook pour définir le type de données géré par ce repository
import com.sameh.entity.UserBook;

import org.springframework.data.jpa.repository.JpaRepository;
import org.springframework.stereotype.Repository;

//Annotation @Repository indiquant à Spring que cette classe est un composant géré par le conteneur Spring IoC
//Ce composant est responsable de l'accès aux données pour l'entité UserBook

@Repository
//Interface définissant un repository pour l'entité UserBook avec une clé primaire de type Integer
public interface UserBookRepository extends JpaRepository<UserBook, Integer> {
	...
	// base de données
	// pour l'entité UserBook, en évitant d'avoir à écrire du code spécifique pour
	// chaque opération CRUD.

	// Il suffit d'injecter UserBookRepository dans d'autres composants (services,
	// contrôleurs, etc.)
