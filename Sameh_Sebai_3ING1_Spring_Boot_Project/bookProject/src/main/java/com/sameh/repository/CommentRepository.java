...
// Importation de l'entité Comment pour définir le type de données géré par ce repository
import com.sameh.entity.Comment;

// Interface définissant un repository pour l'entité Comment avec une clé primaire de type Long
public interface CommentRepository extends JpaRepository<Comment, Long> {
	...
	// base de données
	// pour l'entité Comment, en évitant d'avoir à écrire du code spécifique pour
	// chaque opération CRUD.

	// Il suffit d'injecter CommentRepository dans d'autres composants (services,
	// contrôleurs, etc.)
